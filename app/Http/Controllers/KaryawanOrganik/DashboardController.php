...
class DashboardController extends Controller
{
    ...
    public function riwayat(Request $request)
    {
        ...
        $trainingHistory = $query->paginate(10); 

        $hasDrafts = TrainingPlan::where('user_id', $user->id)->where('status', 'draft')->exists();

        return view('karyawan.riwayat', compact('trainingHistory', 'hasDrafts'));
    }
}