        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @empty
                ...
                <div class="col-span-full py-16 text-center bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700">
                    ...
                    <a href="{{ route('admin.trainings.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 transition shadow-md gap-2">
                        <ion-icon name="add-circle-outline" class="text-lg"></ion-icon>
                        Tambah Pelatihan
                    </a>
                </div>
